...
from utils import question_to_vec, text_prepare, unpickle_file, load_embeddings
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        # Create object of class Chatbot with the specified parameters
#        self.chitchat_bot = ChatBot("Botty", trainer = "chatterbot.trainers.ChatterBotCorpusTrainer")
#        # Call train method for training it
